  ...
  return (
    <div className="flex grow flex-col md:flex-row items-center justify-center h-screen">
      ...
      <div className=" flex flex-col w-full h-full text-white  bg-black items-center justify-center">
        <h1 className="text-center text-4xl mb-5 font-thin">
          Where design meets technology
        </h1>
        <p className="text-center">
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Deleniti
          aperiam corrupti pariatur debitis ullam sunt voluptatum! Unde quos sed
          quas labore illum. Eaque nulla error fugit aliquid eveniet ipsum vel.
        </p>
      </div>
    </div>
  );
